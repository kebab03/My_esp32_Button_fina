...
def toggle():
    ...
    if request.method == 'POST':
        ...
        print("--Line 88 -----num_buttons from esp32  /toogle ----------------")
        #print(data)
        print(num_buttons)
        print("--Line 92---fine ---button_labels from esp32 ----------------")
        print(button_labels)
        print("--Line 93---fine ---button_states from esp32 ----------------")
        print(button_states)

        print("--Line 96 -----num_buttonsType from esp32  /toogle ----------------")
        #print(data)
        print(type(num_buttons))
        print("--Line 99---fine ---button_labels from esp32 ----------------")
        print(type(button_labels))
        print("--Line 101---fine ---button_states from esp32 ----------------")
        print(type(button_states))
...
#################à
   ...
   # return render_template('toggle.html', button_data=result)
